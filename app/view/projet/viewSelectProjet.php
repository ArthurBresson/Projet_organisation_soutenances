...
<body>
  <div class="container">
    ...
    <div>
      <h1>Choississez le projet dont vous voulez voir les créneaux</h1>
      <?php
      form_begin(' ', 'GET', 'router1.php');

      form_input_hidden("action", "projetSelected");
      form_datalist_projet("Label du projet", "label", $projets_unique);
